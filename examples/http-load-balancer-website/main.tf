...
module "static_site" {
  ...
  # source = "git::git@github.com:gruntwork-io/terraform-google-static-assets.git//modules/cloud-load-balancer-website?ref=v0.1.0"
  source = "../../modules/cloud-load-balancer-website"
